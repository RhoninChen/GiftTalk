...
import com.l000phone.dy.bean.SelectDetailInfo;
import com.l000phone.dy.common.UrlConfig;
import com.l000phone.dy.customview.CustomScrollView;
import com.l000phone.dy.customview.ScrollViewListener;
import com.l000phone.dy.fragment.SelectDetailCommentFragment;
import com.l000phone.dy.fragment.SelectDetailIntroduceFragment;
...
public class SelectDetailActivity extends BaseActivity {
    ...
    @BindView(R.id.cb_select_detail)
    ConvenientBanner mConvenientBanner;
    private List<String> convenientBannerImgUrlList = new ArrayList<>();

    @BindView(R.id.tv_select_detail_name)
    TextView tvName;
    @BindView(R.id.tv_select_detail_price)
    TextView tvPrice;
    @BindView(R.id.tv_select_detail_description)
    TextView tvDescription;

    @BindView(R.id.rg_select_detail)
    RadioGroup mRadioGroup;

    @BindView(R.id.tv_select_detail_introduce_line)
    TextView tvIntroduce;
    @BindView(R.id.tv_select_detail_comment_line)
    TextView tvComment;

    @BindView(R.id.vp_select_detail)
    ViewPager mViewPager;
    private List<Fragment> fragmentList = new ArrayList<>();
    private CategoryFragmentPagerAdapter fragmentPagerAdapter;

    @BindView(R.id.sv_select_detail)
    CustomScrollView mScrollView;
    @BindView(R.id.fl_select_detail_toolbar)
    FrameLayout mFrameLayout;

    @BindView(R.id.ib_select_detail_back)
    ImageButton ibBack;
    @BindView(R.id.ib_select_detail_share)
    ImageButton ibShare;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        OkHttpUtils.newInstance().doGet(url, SelectDetailInfo.class
