...
import com.l000phone.dy.adapter.SelectDetailCommentListViewAdapter;
...
public class SelectDetailCommentFragment extends BaseFragment {
    ...
    @BindView(R.id.lv_fg_select_detail_comment)
    ListView mListView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        OkHttpUtils.newInstance().doGet(url, SelectDetailCommentInfo.class, new IOkCallBack<SelectDetailCommentInfo>() {
            @Override
